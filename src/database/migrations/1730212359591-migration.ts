...
export class Migration1730212359591 implements MigrationInterface {
    name = 'Migration1730212359591'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "dn-xanh"."landfill_entity_type_enum" AS ENUM('REGULATED', 'ILLEGAL')`);
        await queryRunner.query(`CREATE TYPE "dn-xanh"."landfill_entity_level_enum" AS ENUM('NORMAL', 'BASIC_POLLUTANTS', 'TOXICANTS')`);
        await queryRunner.query(`CREATE TABLE "dn-xanh"."landfill_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying(100) NOT NULL, "description" text NOT NULL, "location_latitude" double precision NOT NULL DEFAULT '16.06', "location_longitude" double precision NOT NULL DEFAULT '-251.84', "type" "dn-xanh"."landfill_entity_type_enum" NOT NULL, "level" "dn-xanh"."landfill_entity_level_enum" NOT NULL DEFAULT 'NORMAL', "reported_by_user_id" uuid NOT NULL, CONSTRAINT "PK_79ba446bfa273e14fade4cbd8c9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "dn-xanh"."user_entity_role_enum" AS ENUM('USER', 'CONTRIBUTOR', 'ADMIN')`);
        await queryRunner.query(`CREATE TABLE "dn-xanh"."user_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "first_name" character varying(255) NOT NULL, "last_name" character varying(255), "email" character varying(100) NOT NULL, "password" character varying(100) NOT NULL, "address" character varying(255), "green_point" integer NOT NULL DEFAULT '0', "role" "dn-xanh"."user_entity_role_enum" NOT NULL DEFAULT 'USER', CONSTRAINT "UQ_415c35b9b3b6fe45a3b065030f5" UNIQUE ("email"), CONSTRAINT "PK_b54f8ea623b17094db7667d8206" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "dn-xanh"."smart_recycle_bin_classification_history_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "volume" double precision NOT NULL, "is_correct" boolean NOT NULL, "is_claimed" boolean NOT NULL DEFAULT false, "physical_recycle_bin_id" uuid NOT NULL, "classify_by_user_id" uuid, CONSTRAINT "PK_49597e3c431377f003f3ba439df" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "dn-xanh"."physical_recycle_bin_entity_waste_type_enum" AS ENUM('RECYCLABLE', 'ORGANIC', 'NON_RECYCLABLE')`);
        ...
        await queryRunner.query(`ALTER TABLE "dn-xanh"."landfill_entity" ADD CONSTRAINT "FK_08e8899b37d57c58c5b174b8335" FOREIGN KEY ("reported_by_user_id") REFERENCES "dn-xanh"."user_entity"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dn-xanh"."smart_recycle_bin_classification_history_entity" ADD CONSTRAINT "FK_1ab2045dc7d0ebe5b06ecb8d04d" FOREIGN KEY ("physical_recycle_bin_id") REFERENCES "dn-xanh"."physical_recycle_bin_entity"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dn-xanh"."smart_recycle_bin_classification_history_entity" ADD CONSTRAINT "FK_6ca82d8a8c6041dd6c017bc85fd" FOREIGN KEY ("classify_by_user_id") REFERENCES "dn-xanh"."user_entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dn-xanh"."smart_recycle_bin_classification_history_entity" DROP CONSTRAINT "FK_1ab2045dc7d0ebe5b06ecb8d04d"`);
        await queryRunner.query(`ALTER TABLE "dn-xanh"."landfill_entity" DROP CONSTRAINT "FK_08e8899b37d57c58c5b174b8335"`);
        await queryRunner.query(`DROP TABLE "dn-xanh"."smart_recycle_bin_clean_history_entity"`);
        await queryRunner.query(`DROP INDEX "dn-xanh"."IDX_1aee3a5e3bc381a9739a766a8e"`);
        ...
        await queryRunner.query(`DROP TABLE "dn-xanh"."landfill_entity"`);
        await queryRunner.query(`DROP TYPE "dn-xanh"."landfill_entity_level_enum"`);
        await queryRunner.query(`DROP TYPE "dn-xanh"."landfill_entity_type_enum"`);
    }
